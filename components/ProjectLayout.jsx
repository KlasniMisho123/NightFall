  ...
  return (
    <section className="py-6 flex justify-center gap-8 w-full text-white">
        ...
        <div className='mt-16 flex flex-1 flex-col gap-16 '>
            <ProjectCard year={2024} projectName="EspressoMeter" title=" Coffee Tracking for Cofee Fiends" webLink="https://espresso-meter.vercel.app/" projectSecondaryColor="pink" client="Developeing Skills"
