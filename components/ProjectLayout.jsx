  ...
  return (
    <section className="my-4 flex justify-center gap-8 w-full text-white">
        <div className='flex flex-1 flex-col gap-16 '>
            ...
            <ProjectCard year={2024} projectName="NightFall Web" title="- Digitize Your Idea" webLink="https://night-fall.vercel.app/" projectSecondaryColor="blue" client="Developeing Skills"
        ...
        <div className='mt-16 flex flex-1 flex-col gap-16 '>
            <ProjectCard year={2024} projectName="EspressoMeter" title=" Coffee Tracking for Cofee Fiends" webLink="https://espresso-meter.vercel.app/" projectSecondaryColor="red" client="Developeing Skills"
            ...
            <ProjectCard year={2024} projectName="EspressoMeter" title=" Coffee Tracking for Cofee Fiends" webLink="https://espresso-meter.vercel.app/" projectSecondaryColor="indigo" client="Developeing Skills"
            time="2 Weeks" service="Web Page Development" imgSrc="EspressoMeter.png"
