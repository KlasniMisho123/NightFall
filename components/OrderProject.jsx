...
export default function OrderProject() {
  return (
    <div className="flex flex-col md:flex-row justify-between gap-8 items-center my-12 p-6 rounded-lg shadow-md bg-white/60 backdrop-blur-lg">
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h4 className="text-2xl font-semibold mb-2 text-blue-500">
                Ready to Launch <i className="fa-solid fa-rocket"></i>
              </h4>
              <p className="text-sm leading-relaxed">
                We design and develop custom websites tailored to your needs — fast, modern, and fully responsive. Let's bring your project to life!
              </p>
            </div>
          </div>
        </div>

        <button className="self-center mt-4 flex items-center gap-2 bg-blue-100 px-5 py-2 rounded-md hover:bg-blue-200 text-blue-600 font-medium transition cursor-pointer">
