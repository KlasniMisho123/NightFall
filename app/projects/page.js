  ...
  return (
    <div className="transition-all transition-duration-300 bg-nightfall">
      ...
      style={{
        ...
        <section className='my-10 mx-[10%] md:mx-[20%] hero-stats-load '>
          <BorderedTitle text="Our Projects" color="blue-500" angle={5}/>
          <div className='text-white my-6'>
            <h1 className={`text-white text-4xl my-4 sm:text-5xl md:text-6xl lg:text-7xl font-bold mt-2 sm:whitespace-nowrap text-center leading-tight ` + urbanist.className} >Sharing Our Experience <br/> <span className='text-blue-500/80 '> With You  </span></h1>
